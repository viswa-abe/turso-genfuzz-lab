#!/usr/bin/env python3
"""turso_genfuzz -- Turso adapter for the genlib differential harness (EXP-101/102).
...
end-to-end only in the guest (EXP-102). The sqlite3-vs-sqlite3 path runs anywhere.
"""
import hashlib
import os
import secrets
...
def _vendor_paths() -> tuple[Path, Path, Path]:
    ...
    # EXP-101 host -- where parents[2] does NOT point at a turso project -- can still be
